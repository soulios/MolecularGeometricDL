...
| [Neural Message Passing for Quantum Chemistry](https://proceedings.mlr.press/v70/gilmer17a.html)| Gilmer et al. | 2017 |[Github](https://github.com/priba/nmp_qc)| Introduced the concept of Message passing networks. Alsotried to encode spatial info about the graph by dostance binss, super nodes and virtual edges and resembled model ensembling by the concept of multiple towers🔥🔥🔥|QM9|
|[Low Data Drug Discovery with One-Shot Learning](https://pubs.acs.org/doi/10.1021/acscentsci.6b00367) | Altae-Tran et al. | 2017|[DeepChem](https://github.com/deepchem)|One-shot learning in graph classification tasks paired with LSTM updates|Tox21,SIDER,MUV|
...
|[PotentialNet for Molecular Property Prediction](https://pubs.acs.org/doi/full/10.1021/acscentsci.8b00507) | Feinberg et al. | 2018| [DGL-lifesci](https://github.com/awslabs/dgl-lifesci) | Used another type of split called agglomerative|PDBBind,QM8,Tox21(0.856)|
...
|[Molecule Property Prediction Based on Spatial Graph Embedding](https://pubs.acs.org/doi/10.1021/acs.jcim.9b00410) | Wang et al. | 2018|[Github](https://github.com/1128bian/C-SGEN)|1D-convolutions on each atom's features using skip connections|ESOL,lipophilicity,PDBBind|
